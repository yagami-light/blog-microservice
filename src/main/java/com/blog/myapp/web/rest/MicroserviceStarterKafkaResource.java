...
@RestController
@RequestMapping("/api/microservice-starter-kafka")
public class MicroserviceStarterKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MicroserviceStarterKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MicroserviceStarterKafkaResource(KafkaProperties kafkaProperties) {
